...
const TuitionForeignCitizens = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fees
        const feesRes = await fetch('http://localhost:8000/api/admissions/fees-foreign/?lang=' + i18n.language);
        ...
        // Bank details
        const bankRes = await fetch('http://localhost:8000/api/admissions/requisities-foreign/?lang=' + i18n.language);
        ...
        // Contacts
        const contactsRes = await fetch('http://localhost:8000/api/admissions/contacts-foreign/?lang=' + i18n.language);
