...
const FAQ = () => {
  ...
  const categories = [
    { id: 'general', name: t('faq.categories.general'), icon: '❓', count: 8 },
    { id: 'documents', name: t('faq.categories.documents'), icon: '📄', count: 6 },
    { id: 'exams', name: t('faq.categories.exams'), icon: '✍️', count: 7 },
    { id: 'payment', name: t('faq.categories.payment'), icon: '💰', count: 5 },
    { id: 'hostel', name: t('faq.categories.hostel'), icon: '🏠', count: 4 }
  ];

  const faqs = {
    general: [
      {
        question: t('faq.questions.general.admissionStart'),
        answer: t('faq.answers.general.admissionStart')
      },
      {
        question: t('faq.questions.general.programs'),
        answer: t('faq.answers.general.programs')
      },
      {
        question: t('faq.questions.general.duration'),
        answer: t('faq.answers.general.duration')
      },
      {
        question: t('faq.questions.general.languages'),
        answer: t('faq.answers.general.languages')
      },
      {
        question: t('faq.questions.general.internship'),
        answer: t('faq.answers.general.internship')
      },
      {
        question: t('faq.questions.general.diplomaRecognition'),
        answer: t('faq.answers.general.diplomaRecognition')
      },
      {
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-800 mb-2">{t('faq.contact.admissionOffice')}</h4>
              <p className="text-indigo-600 font-medium text-lg">+996 312 123 456</p>
              <p className="text-gray-600 mt-1">{t('faq.contact.hours.weekdays')}</p>
              <p className="text-gray-600">{t('faq.contact.hours.saturday')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-1">{t('faq.contact.responseTime')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-1">{t('faq.contact.whatsapp')}</p>
            </div>
          </div>

          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="text-center">
              <h4 className="font-semibold text-gray-800 mb-4">{t('faq.contact.officeAddress')}</h4>
              <p className="text-gray-600">
                {t('faq.contact.address')}
              </p>
              <p className="text-gray-600 mt-2">
                📍 <span className="text-indigo-600 hover:underline cursor-pointer">{t('faq.contact.showMap')}</span>
              </p>
            </div>
          </div>
        </div>
